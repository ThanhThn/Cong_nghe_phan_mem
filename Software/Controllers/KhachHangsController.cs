...
namespace Software.Controllers
{
    public class KhachHangsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaKH,TenKhachHang,SoDT")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaKH,TenKhachHang,SoDT")] KhachHang khachHang)
        {
